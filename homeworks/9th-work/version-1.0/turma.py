...
class FaltouDisciplina(Exception):
    pass
...
class LimiteInsereTurma(tk.Toplevel):
    def __init__(self, controle, listaCodDiscip, listaNroMatric):
        ...
        self.buttonFechar = tk.Button(self.frameButton, text = "Fechar", font = ('Negrito', 9))
        self.buttonFechar.pack(side="left")
        self.buttonFechar.bind("<Button>", controle.fecharHandler)
